...
# Примечание
# По этой задаче возникает непонимание.
# Например, как ввести первый тест, если
# после ввода нуля программа завершает
# работу и не дает ввести оставшееся число 5?
# Можно ввести несколько строчек за раз
# (в том числе и полный тест), скопировав и вставив их.
