...
# Посмотрим сразу на примере. По заданному количеству глаз и ног 
# нужно научиться отличать кошку, паука, морского гребешка и жучка. 
...
#  осуществить выбор больше чем из двух вариантов,
#   которые могут быть обработаны с помощью if-else.
#    Рассмотрим пример: необходимо вывести словом название
#    числа 1 или 2 или сообщить, что это другое число:
